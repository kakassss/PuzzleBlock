...
public class LevelController : MonoBehaviour
{
    ...
    [Inject]
    private void Construct(IPieceSpawnPositionService pieceSpawnPositionService, ILevelPersistenceService levelPersistenceService)
    {
    ...
    private void SaveLevel(string levelName)
    {
        ...
        foreach (var piece in pieces)
        {
            ...
            foreach (var spawnedPiece in spawnedPieces)
            {
                ...
                {
                    pieceData.startPosition = _pieceSpawnPositionService.GetSpawnPosition();
                    break;
                }
            }
